    ...
    <Drawer.Root onClose={blurOnClose} shouldScaleBackground={true}>
      ...
      <Drawer.Portal>
        <Drawer.Overlay className="fixed inset-0 bg-black/40" />
          <Drawer.Content className="bottom-0 left-0 right-0 outline-0 flex bg-white dark:bg-gray-800 flex-col rounded-t-[10px] h-fit mt-24 fixed bottom-0 left-0 right-0">
