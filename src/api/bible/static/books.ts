...
export const selectedBibleVersions: readonly string[] = [
  ...englishBibleVersions,
  ...spanishBibleVersions,
] as const;
export type bibleVersion = (typeof selectedBibleVersions)[number];
export const bibleVersionData: {
  [key in bibleVersion]: {
    readableName: string;
    attribution: string;
    language: "es" | "en";
  ...
  RV1960: {
    ...
    attribution:
      "© Sociedades Bíblicas Unidas, 1960. Todos los derechos reservados. Sociedades Bíblicas Unidas (SBU): https://unitedbiblesocieties.org/es/casa/",
  },
  NVI: {
    language: "es",
    readableName: "NVI - Nueva Versión Internacional",
    attribution:
      "Nueva Versión Internacional® © 2015 por Biblica, Inc.® Todos los derechos reservados. Biblica, Inc.: https://www.biblica.com/",
  },
  NTV: {
    language: "es",
    readableName: "NTV - Nueva Traducción Viviente",
    attribution:
      "Nueva Traducción Viviente® © 2010 Tyndale House Foundation.® Todos los derechos reservados. Tyndale House Foundation: https://www.tyndale.com/",
  },
};
...
export const NLT_BOOKS: Book[] = [
  ...
  { bookid: 19, name: "Psalms", chronorder: 13, chapters: 150 },
  { bookid: 20, name: "Proverbs", chronorder: 17, chapters: 31 },
  { bookid: 21, name: "Ecclesiastes", chronorder: 18, chapters: 12 },
  { bookid: 22, name: "Song of Solomon", chronorder: 14, chapters: 8 },
